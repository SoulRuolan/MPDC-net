...
parser.add_argument('--root_path', type=str, default='/root/autodl-tmp/Database/ACDC/h5py/test/',
...
def Inference(FLAGS):
    ...
    snapshot_path = "../model/ACDC".format(FLAGS.model, FLAGS.exp, FLAGS.labeled_num)
    test_save_path = "../model/ACDC/predictions/".format(FLAGS.model, FLAGS.exp, FLAGS.labeled_num)
